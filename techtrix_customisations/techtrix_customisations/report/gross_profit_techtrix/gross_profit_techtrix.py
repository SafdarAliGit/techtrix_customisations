...
class GrossProfitGenerator(object):
	...
	def load_invoice_items(self):
		...
		if self.filters.group_by == "Sales Person":
			...
			sales_person_cols = ", `tabSales Invoice`.sales_person, sales.allocated_amount, sales.incentives"
			sales_team_table = "right join `tabSales Team` sales on sales.parent = `tabSales Invoice`.name"
		else:
			sales_person_cols = ""
			sales_team_table = ""
